...
good_dir = os.path.join(out_dir, "pass_pyr")
bad_dir = os.path.join(out_dir, "fail_pyr")
os.makedirs(good_dir, exist_ok=True)
os.makedirs(bad_dir, exist_ok=True) 
accepted_metrics_file = os.path.join(good_dir, "pass_pyr_ter.csv")
failed_metrics_file = os.path.join(bad_dir, "fail_pyr_ter.csv")
all_binders = os.path.join(out_dir, "all_af3_pyr_ter.csv")
