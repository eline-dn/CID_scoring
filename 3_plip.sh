...
if [! -f ".output/pass_af3/pass_pyr/_plip_interactions.csv"]; then
...
python "$SDIR/scripts/3.2_merge_plip_ter.py" --plip_csv ./output/pass_af3/pass_pyr/_plip_interactions.csv --accepted1_csv ./output/pass_af3/pass_pyr/pass_af3_pyr_ter.csv --out_dir ./output/pass_af3/pass_pyr
